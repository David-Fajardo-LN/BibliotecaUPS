...
public class ListarUsuariosView extends javax.swing.JInternalFrame {
    ...
    public void actualizarIdioma(ResourceBundle bundle){
        jLabel1.setText(bundle.getString("titulo.VentanaListarUsuarios"));
        btnListar.setText(bundle.getString("btn.listar"));
        btnRegresar.setText(bundle.getString("btn.cancelar"));

        DefaultTableModel modelo = (DefaultTableModel) TablaUsuariosListar.getModel();
        modelo.setColumnIdentifiers(new Object[]{
            bundle.getString("cedulaGeneral.IngresarDato"),
            bundle.getString("nombreGeneral.IngresarDato"),
            bundle.getString("correoElectronicoGeneral.IngresarDato"),
            bundle.getString("numeroTelefonicoGeneral.IngresarDato")
        });
    }

    public JTable getTablaUsuariosListar() {
        return TablaUsuariosListar;
    }
    ...
    private void initComponents() {
        ...
        TablaUsuariosListar = new javax.swing.JTable();
        ...
        TablaUsuariosListar.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, null, null, null},
                {null, null, null, null},
                {null, null, null, null},
            ...
            new String [] {
                "Cedula", "Nombre", "Correo Electronico", "Telefono"
            }
        ) {
        ...
        jScrollPane1.setViewportView(TablaUsuariosListar);
    ...
    private javax.swing.JTable TablaUsuariosListar;
